...
const tempLogFields = async (req, res, next) => {
    try {
        ...
        const title = [];
        if (
            record.titleName === 'Daily Chiller-1 Log Book - Centrifugal Chillers - 19XRA6/7' ||
            record.titleName === 'Daily Chiller-2 Log Book - Centrifugal Chillers - 19XRA6/7' ||
            record.titleName === 'Daily Chiller-3 Log Book - Centrifugal Chillers - 19XRA6/7' ||
            record.titleName === 'Daily Chiller-4 Log Book - Centrifugal Chillers - 19XRA6/7'
        ) {
